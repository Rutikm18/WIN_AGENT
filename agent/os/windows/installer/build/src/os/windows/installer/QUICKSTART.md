...
```powershell
msiexec /i attacklens-agent-2.0.0-x64.msi
```
...
Upload `attacklens-agent-2.0.0-x64.msi` to your MDM or GPO software distribution.
...
```
msiexec /i attacklens-agent-2.0.0-x64.msi /qn MANAGER_URL="http://34.224.174.38:8080" AGENT_NAME="%COMPUTERNAME%"
```
