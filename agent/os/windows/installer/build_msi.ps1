...
.PARAMETER Version
    Semantic version embedded in MSI metadata. Default: 2.0.1
...
.EXAMPLE
    ...
    .\build_msi.ps1 -Version "2.0.1" -SignIdentity "CN=AttackLens Inc"
...
.EXAMPLE
    ...
    msiexec /i dist\attacklens-agent-2.0.1-x64.msi /qn `
...
Sets sys.path to src\, points MACINTEL_CONFIG to agent.toml in ProgramData,
