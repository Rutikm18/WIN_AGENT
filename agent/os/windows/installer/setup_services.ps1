...
if ($Action -eq "Install") {
    ...
    # Offline collection is a supported mode. Legacy network dependencies can
    # produce ERROR_SERVICE_DEPENDENCY_FAIL (1068) when DNS Client is disabled.
    & sc.exe config $AGENT_SVC depend= / | Out-Null
    ...
    & sc.exe config  $WATCHDOG_SVC depend= / | Out-Null
